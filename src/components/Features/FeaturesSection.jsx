...
const FeaturesSection = () => {
    ...
    useEffect(() => {
        ...
        ScrollTrigger.create({
            ...
            onEnterBack: () => { 
                goToSection(-50);
                // ScrollTrigger.getById('tl2Trigger').disable()
            },
            onLeave: () => {
                // ScrollTrigger.getById('tl2Trigger').enable();
                // tl2.play()
            }
          });
        ...
        //   ScrollTrigger.create({
        //     id: 'tl2Trigger',
        //     trigger: '.SecondTrigger', // The element you want to trigger the second part of the animation
        //     start: 'bottom-=23% center', // Start when the bottom of the trigger element hits the bottom of the viewport
        //     animation: tl2, // Use the second created GSAP timeline (tl2)
        //     scrub: 2,
        //     snap: [0,1],
        //     onEnter: () => { 
    ...
    return (
        ...
        <div className="center-mask" style={{ paddingTop: isChecked ? '300px' : '250px' }}>
            ...
            <div className='SecondTrigger'></div>
            </div>
    );
};
